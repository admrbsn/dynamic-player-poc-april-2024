  ...
  <div class="swiper-wrapper md:py-3 md:bg-black">
    <div class="relative">
      ...
      >
        ...
        >
          <div
            class="w-full h-[300px] md:w-[768px] md:h-[432px] mx-auto rounded overflow-hidden"
          >
    ...
    <div class="relative">
      ...
      >
        ...
        >
          ...
          <div
            v-if="item.name"
            class="absolute bottom-0 left-0 w-full h-8 flex items-end pb-1 px-1 text-white text-[10px] font-semibold"
          >
